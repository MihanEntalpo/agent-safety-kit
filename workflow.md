...
## Задача: Добавить игнорирование loopback и .local в proxychains конфиги
### Проблемы и blockers
- Блокирующих проблем не выявлено.
### Решения и заметки
- В шаблоны proxychains-конфигов для запуска и установки агентов добавлены localnet-правила для loopback и доменов `.local`, с кратким комментарием о формате.

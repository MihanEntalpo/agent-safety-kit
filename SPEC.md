...
2. определяет mount-контекст:
   ...
   - если выбранная рабочая директория не существует — завершает команду с ошибкой;
   - по выбранной рабочей директории ищет mount;
   - если подходящий mount не найден — завершает команду с ошибкой;
...
3. определяет рабочую директорию в VM на основе mount и относительного подпути внутри него;

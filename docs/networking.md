...
The `agsekit portforward` command creates and maintains SSH tunnels into and out of the VM and periodically rereads the config to reconnect forwards when rules change. The agsekit daemon currently runs this command as one of its background workers.

...
This directory contains the user-facing reference documentation for `agsekit`.

Use this index if you already know what the project is and need operational guidance.

## Start Here

- [Getting started](getting-started.md)
- [How-to recipes](how-to.md)

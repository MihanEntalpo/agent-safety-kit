...
- [Команда](#команда)
- [Важное правило разбора аргументов](#важное-правило-разбора-аргументов)
- [Правила workdir](#правила-workdir)
- [Проверки mount](#проверки-mount)
- [Runtime helper'ы](#runtime-helperы)
...
- запускать daemon-поток, который периодически выполняет `agsekit check-new-version`, если включён `global.check_new_version`; эта же команда обновляет просроченные суточные latest-version записи настроенных типов агентов;

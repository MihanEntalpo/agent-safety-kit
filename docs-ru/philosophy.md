...
- Границы обмена данными должны быть enforceable на уровне директорий: для монтирования можно явно разрешить только конкретные профили агентов (например, только self-hosted для NDA-чувствительных папок).
...
8. Доступ к чувствительным папкам проекта должен ограничиваться политикой, а не памятью пользователя.

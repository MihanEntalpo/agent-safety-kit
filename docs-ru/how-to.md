...
- [Монтирование папок](#монтирование-папок)
- [Self-hosted OpenAI-compatible API](#self-hosted-openai-compatible-api)
- [Запуск codex и claude-code при ограничениях доступа](#запуск-codex-и-claude-code-при-ограничениях-доступа)
...
После того как проброс портов активен, запускаем агента как обычно из примонтированной папки проекта:

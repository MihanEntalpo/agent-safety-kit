...
На сайтах как ИИ-гигантов, так и маленьких команд, создающих собственных агентов, установка часто выглядит как `curl | bash`, `npm i -g ...` и затем `<agent_name>`. 
...
Другие истории в неограниченных количествах можно найти в Google по запросу: `Coding Agent Destroyed|Wiped|deleted`
